...
(function($){
    ...
    $.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,40,50],loading:false,buttons:null,showPageList:true,showPageInfo:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh","info"],onBeforeSelectPage:function(_d2,_d3){
    },onSelectPage:function(_d4,_d5){
    },onBeforeRefresh:function(_d6,_d7){
    },onRefresh:function(_d8,_d9){
    },onChangePageSize:function(_da){
    },beforePageText:"Страница",afterPageText:"из {pages}",displayMsg:"Показано с {from} по {to} из {total} кандидатов",nav:{first:{iconCls:"pagination-first",handler:function(){
    ...
    $.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"Ок",cancel:"Отмена",width:300,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
    }});
    })(jQuery);
    (function($){
    ...
    $.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"Это обязательное поле!",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:true,validateOnBlur:false,events:{focus:_54c,blur:_550,mouseenter:_553,mouseleave:_556,click:function(e){
    var t=$(e.data.target);
